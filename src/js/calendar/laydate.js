...
! function(a) {
	var b = {
		...
		h = ["laydate_box", "laydate_void", "laydate_click", "LayDateSkin", "need/", "/laydate.css"];
	a.laydate = function(b) {
		...
		c.use("need"), c.use(h[4] , h[3]), c.skinLink = c.query("#" + h[3])
